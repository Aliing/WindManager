...
/**
 * <p>Java class for http-auth-user-password complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="http-auth-user-password">
 *   &lt;complexContent>
...
@XmlType(name = "http-auth-user-password", namespace = "http://www.aerohive.com/configuration/ssid", propOrder = {
    "password"
})
public class HttpAuthUserPassword {
