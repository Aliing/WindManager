...
/**
 * <p>Java class for fe-tunnel-multicast-forward-allow complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="fe-tunnel-multicast-forward-allow">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="AH-DELTA-ASSISTANT" type="{http://www.aerohive.com/configuration/general}ah-only-act" minOccurs="0"/>
 *         &lt;element name="except" type="{http://www.aerohive.com/configuration/general}ah-name-act-value" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "fe-tunnel-multicast-forward-allow", propOrder = {
    "ahdeltaassistant",
    "except"
})
public class FeTunnelMulticastForwardAllow {

    @XmlElement(name = "AH-DELTA-ASSISTANT")
    protected AhOnlyAct ahdeltaassistant;
    protected List<AhNameActValue> except;
     ...
     * 
     */
    public List<AhNameActValue> getExcept() {
        if (except == null) {
            except = new ArrayList<AhNameActValue>();
        }
        return this.except;
    }
