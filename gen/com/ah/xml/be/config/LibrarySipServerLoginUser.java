...
/**
 * <p>Java class for library-sip-server-login-user complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="library-sip-server-login-user">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="password" type="{http://www.aerohive.com/configuration/general}ah-encrypted-string"/>
 *       &lt;/sequence>
...
@XmlType(name = "library-sip-server-login-user", namespace = "http://www.aerohive.com/configuration/aaa", propOrder = {
    "password"
})
public class LibrarySipServerLoginUser {
