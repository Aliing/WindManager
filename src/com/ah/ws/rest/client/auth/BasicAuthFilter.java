 ...
 * holder.
 */
package com.ah.ws.rest.client.auth;
...
public final class BasicAuthFilter extends ClientFilter {
    ...
    static public final Charset CHARACTER_SET = Charset.forName("iso-8859-1");
     ...
     * @param password
     */
    public BasicAuthFilter(final String username, final byte[] password) {
        generateAuthentication(username, password);
    }
