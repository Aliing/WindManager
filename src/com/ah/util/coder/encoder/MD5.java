...
public class MD5 extends MessageDigest implements Cloneable {
	...
	public byte[] engineDigest() {
		...
		engineUpdate((byte) 0x80); // 10000000 in binary; the start of the
		// padding
		...
		// the padding
		W[14] = SWAP((int) bitcount);
		W[15] = SWAP((int) (bitcount >>> 32));
		bytecount += 8;
		...
		byte[] result = new byte[] { (byte) (A >>> 24), (byte) (A >>> 16),
				(byte) (A >>> 8), (byte) A, (byte) (B >>> 24),
				(byte) (B >>> 16), (byte) (B >>> 8), (byte) B,
				(byte) (C >>> 24), (byte) (C >>> 16), (byte) (C >>> 8),
				(byte) C, (byte) (D >>> 24), (byte) (D >>> 16),
				(byte) (D >>> 8), (byte) D };
	...
	private void munch() {
		...
		/*
		 * The hex constants are from md5.c in FSF Gnu Privacy Guard 0.9.2
		 */
		/* Round 1. */
		/*
