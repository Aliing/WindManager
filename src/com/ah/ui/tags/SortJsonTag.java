...
public class SortJsonTag extends ActionSupport implements Tag {
	...
	public int doStartTag() throws JspException {
		...
		if (sortParams == null) {
			...
			if (name.equals(sortParams.getOrderBy())) {
		...
		StringBuffer results = new StringBuffer("<a href=\"#\" onclick=\"");
		...
		results.append("</b></a>");
		if (sortParams != null && name.equals(sortParams.getOrderBy())) {
