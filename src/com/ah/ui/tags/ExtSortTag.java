...
public class ExtSortTag extends ActionSupport implements Tag {
	protected Tracer log = new Tracer(ExtSortTag.class.getSimpleName());
	...
	public int doStartTag() throws JspException {
		...
		if (sortParams == null) {
			...
			url.append("extOrderBy");
			url.append("=");
			url.append(name);
			url.append("&");

			boolean extAscending = true;
			if (name.equals(sortParams.getExtOrderBy())) {
				extAscending = !sortParams.isExtAscending();
			}
			url.append("extAscending");
			url.append("=");
			url.append(Boolean.toString(extAscending));
		}
		...
		results.append("</b></a>");
		if (sortParams != null && name.equals(sortParams.getExtOrderBy())) {
