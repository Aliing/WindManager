...
public class PacketVersionInfo2Response {
	 ...
	 * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-
	 * |product type|UID|File size|version length|version|
	 * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-
	 * @return: int length of the data packet response.
	 * 
	 */	
	public static int parseInfoToDownload_2(byte[] bInput, int iOffset, PacketVersion2ResponseData oData)
	{		
        int iLength = 0;
	...
	private static int parseVersionInfo(byte[] bInput, int iOffset,VersionInfoData oInfoData)
	{
		...
		//UID
		oInfoData.setUid(CommTool.bytes2int(bInput, CommConst.Common_INT_Length_Unit_Length, iOffset+iLength));
