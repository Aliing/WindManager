...
public class BeSwitchPortInfoEvent extends BeCapwapClientEvent {
	
	public BeSwitchPortInfoEvent() {
		super();
		queryType = BeCommunicationConstant.CAPWAPCLIENTEVENT_TYPE_SWITCH_PORT_INFO;
	}
	...
	public byte[] buildPacket() throws BeCommunicationEncodeException {
		...
		try {
			...
			throw new BeCommunicationEncodeException("BeSwitchPortInfoEvent.buildPacket() catch exception", e);
		}
	}
}
