...
public class BeRouterLTEVZInfoEvent extends BeCapwapClientEvent {
	
	public BeRouterLTEVZInfoEvent()
	{
		super();
		queryType=BeCommunicationConstant.CAPWAPCLIENTEVENT_TYPE_ROUTER_LTE_VZ_INFO;
	}
	...
	public byte[] buildPacket() throws BeCommunicationEncodeException {
		...
		try {
			...
			throw new BeCommunicationEncodeException("BeRouterLTEVZInfoEvent.buildPacket() catch exception", e);
		}
	}
