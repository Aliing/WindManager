...
/**
 * 
 *@filename		BeInterfaceClientEvent.java
 *@version		V1.0.0.0
 *@author		juyizhou
 *@createtime	2010-3-17 11:20:24
...
public class BeInterfaceClientEvent extends BeCapwapClientEvent {

	public static final byte	TABLETYPE_INTERFACE	= 1;

	public static final byte	TABLETYPE_CLIENT	= 2;
	
	public static final byte    TABLETYPE_DEVICE    = 3;

	private List<Byte>			tableTypeList;

	private boolean				queryAllTable;

	public BeInterfaceClientEvent() {
		super();
		queryType = BeCommunicationConstant.CAPWAPCLIENTEVENT_TYPE_INTERFACECLIENT;
	}
