...
public class BePSEStatusEvent extends BeCapwapClientEvent {

	public BePSEStatusEvent() {
		super();
		queryType = BeCommunicationConstant.CAPWAPCLIENTEVENT_TYPE_PSE_STATUS;
	}
	...
	public byte[] buildPacket() throws BeCommunicationEncodeException {
		...
		try {
			...
			throw new BeCommunicationEncodeException("BePSEStatusEvent.buildPacket() catch exception", e);
		}
	}
}
