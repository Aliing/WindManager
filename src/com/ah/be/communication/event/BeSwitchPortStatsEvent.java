...
public class BeSwitchPortStatsEvent extends BeCapwapClientEvent {
	
	public BeSwitchPortStatsEvent() {
		super();
		queryType = BeCommunicationConstant.CAPWAPCLIENTEVENT_TYPE_SWITCH_PORT_STATS;
	}
	...
	public byte[] buildPacket() throws BeCommunicationEncodeException {
		...
		try {
			...
			throw new BeCommunicationEncodeException("BeSwitchPortStatsEvent.buildPacket() catch exception", e);
		}
	}
}
