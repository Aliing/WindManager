...
/**
 * 
 *@filename		BeModifyUserEvent.java
 *@version		V1.0.0.0
 *@author		juyizhou
...
public class BeModifyUserEvent extends BePortalHMPayloadEvent {

	public BeModifyUserEvent() {
		super();
		operationType = OPERATIONTYPE_USER_MODIFY;
	}
	...
	protected byte[] buildOperationData() throws BeCommunicationEncodeException {
		...
		AhEncoder.putString(buf, user.getClearPassword());
	...
	public byte[] parseRequest() throws Exception {
		...
		user.setClearPassword(AhDecoder.getString(buf));
