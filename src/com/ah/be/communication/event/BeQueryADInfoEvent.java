...
public class BeQueryADInfoEvent extends BeCapwapClientEvent {
	
	public BeQueryADInfoEvent() {
		super();
		queryType = BeCommunicationConstant.CAPWAPCLIENTEVENT_TYPE_QUERYADINFO;
	}
	...
	public byte[] buildPacket() throws BeCommunicationEncodeException {
		...
		try {
			...
			throw new BeCommunicationEncodeException("BeQueryADInfoEvent.buildPacket() catch exception", e);
		}
	}
}
