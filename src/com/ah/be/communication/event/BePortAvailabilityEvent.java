...
public class BePortAvailabilityEvent extends BeCapwapClientEvent {
	
	public BePortAvailabilityEvent() {
		super();
		queryType = BeCommunicationConstant.CAPWAPCLIENTEVENT_TYPE_PORT_AVAILABILITY;
	}
	...
	public byte[] buildPacket() throws BeCommunicationEncodeException {
		...
		try {
			...
			throw new BeCommunicationEncodeException("BeInterfaceAvailabilityEvent.buildPacket() catch exception", e);
		}
	}
}
