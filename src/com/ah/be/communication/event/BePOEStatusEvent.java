...
/**
 * 
 *@filename		BePOEStatusEvent.java
 *@version		V1.0.0.0
 *@author		juyizhou
 *@createtime	2009-4-28 10:19:18
...
public class BePOEStatusEvent extends BeCapwapClientEvent {

	public BePOEStatusEvent() {
		super();
		queryType = BeCommunicationConstant.CAPWAPCLIENTEVENT_TYPE_POESTATUS;
	}
	...
	public byte[] buildPacket() throws BeCommunicationEncodeException {
		...
		try {
			...
			throw new BeCommunicationEncodeException(
					"BePOEStatusEvent.buildPacket() catch exception", e);
		}
	}
