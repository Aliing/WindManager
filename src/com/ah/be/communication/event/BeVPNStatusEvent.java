...
/**
 * 
 *@filename		BeVPNStatusEvent.java
 *@version		V1.0.0.0
 *@author		juyizhou
 *@createtime	2009-11-9 14:01:51
...
public class BeVPNStatusEvent extends BeCapwapClientEvent {
	
	public BeVPNStatusEvent() {
		super();
		queryType = BeCommunicationConstant.CAPWAPCLIENTEVENT_TYPE_VPNSTATUS;
	}
	...
	public byte[] buildPacket() throws BeCommunicationEncodeException {
		...
		try {
			...
			throw new BeCommunicationEncodeException(
					"BeVPNStatusEvent.buildPacket() catch exception", e);
		}
	}
