...
/**
 * 
 *@filename		BeIDPMitigationQueryEvent.java
 *@version		V1.0.0.0
 *@author		juyizhou
 *@createtime	2008-12-5 03:12:47
...
public class BeIDPMitigationQueryEvent extends BeCapwapClientEvent {

	public BeIDPMitigationQueryEvent() {
		super();
		queryType = BeCommunicationConstant.CAPWAPCLIENTEVENT_TYPE_IDPMITIGATION;
	}
	...
	public byte[] buildPacket() throws BeCommunicationEncodeException {
		...
		try {
			...
			throw new BeCommunicationEncodeException(
					"BeIDPMitigationQueryEvent.buildPacket() catch exception", e);
		}
	}
