...
public class BeSwitchPortStatsReportEvent extends BeCapwapClientEvent {
	
	public BeSwitchPortStatsReportEvent() {
		super();
		queryType = BeCommunicationConstant.CAPWAPCLIENTEVENT_TYPE_SWITCH_PORT_STATS_REPORT;
	}
	...
	public byte[] buildPacket() throws BeCommunicationEncodeException {
		...
		try {
			...
			throw new BeCommunicationEncodeException("BeSwitchPortStatsReportEvent.buildPacket() catch exception", e);
		}
	}
}
