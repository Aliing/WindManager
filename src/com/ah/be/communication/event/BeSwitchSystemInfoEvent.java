...
public class BeSwitchSystemInfoEvent extends BeCapwapClientEvent {
	
	public BeSwitchSystemInfoEvent() {
		super();
		queryType = BeCommunicationConstant.CAPWAPCLIENTEVENT_TYPE_SWITCH_SYSTEM_INFO;
	}
	...
	public byte[] buildPacket() throws BeCommunicationEncodeException {
		...
		try {
			...
			throw new BeCommunicationEncodeException("BeSwitchSystemInfoEvent.buildPacket() catch exception", e);
		}
	}
}
