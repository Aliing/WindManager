...
public class BeBonjourGatewayEvent extends BeCapwapClientEvent {
	
	public BeBonjourGatewayEvent() {
		super();
		queryType = BeCommunicationConstant.CAPWAPCLIENTEVENT_TYPE_BONJOUR_GATEWAY;
	}
	...
	public byte[] buildPacket() throws BeCommunicationEncodeException {
		...
		try {
			...
			throw new BeCommunicationEncodeException("BeBonjourGatewayEvent.buildPacket() catch exception", e);
		}
	}
}
