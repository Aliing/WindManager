...
public class BeRadSecCertRevokenEvent extends BeCapwapClientEvent {

    private static final long serialVersionUID = 1L;
    
    private byte csrACK = 1;

    public BeRadSecCertRevokenEvent() {
        super();
        queryType = BeCommunicationConstant.CAPWAPCLIENTEVENT_TYPE_RADSEC_CERT_REVOKEN;
    }
    ...
    public byte[] buildPacket() throws BeCommunicationEncodeException {
        ...
        try {
            ...
            throw new BeCommunicationEncodeException(
                    "BeRadSecCertRevoken.buildPacket() catch exception", e);
        }
    }
