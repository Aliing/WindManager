...
public class ClassifyRogueAp implements ClassifyBaseAp {
	
	public ClassifyRogueAp() {
		
	}
	
	public ClassifyRogueAp(String macAddress) {
	...
	public boolean equals(Object other) {
		return other instanceof ClassifyRogueAp
				&& getMacAddress().equals(((ClassifyRogueAp)other).getMacAddress());
	}
