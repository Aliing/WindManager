/**
 *@filename		TimeZoneInfo.java
 *@version
 *@author		Fiona
 *@createtime	Jul 30, 2007 6:14:05 PM
 ...
 * $Log: TimeZoneInfo.java,v $
 * Revision 1.2  2009/03/16 05:26:07  xfeng
 * fix hiveap daylight bug
 *
...
/** Reads timezone information from /etc/zoneinfo.  Implements the
    ...
    <p>
    Even more unfortunately, in JDK 1.1 <code>java.text.SimpleDateFormat</code>
 ...
 */
public class TimeZoneInfo extends TimeZone {
  private static final long serialVersionUID = 1L;
  ...
  public TimeZoneInfo(File f) throws IOException {
  ...
  public TimeZoneInfo() throws IOException {
    this(new File(LinuxServerTimeManager.TIME_ZONE_MODIFY_FILE));
  }
   ...
   */
  public TimeZoneInfo(String tzname) throws IOException {
    this(new File(LinuxServerTimeManager.TIME_ZONE_FILE_PATH,tzname));
  }
