...
@Entity
@Table(name = "HM_LATESTINTERFERENCESTATS")
@org.hibernate.annotations.Table(appliesTo = "HM_LATESTINTERFERENCESTATS", indexes = {
		@Index(name = "LATEST_INTERFERENCE_STATS_OWNER", columnNames = { "OWNER" }),
		@Index(name = "LATEST_INTERFERENCE_STATS_AP_MAC", columnNames = { "APMAC" })
		})
public class AhLatestInterferenceStats implements HmBo {
