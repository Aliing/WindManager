...
@Entity
@Table(name = "ah_new_sla_stats_week")
@org.hibernate.annotations.Table(appliesTo = "ah_new_sla_stats_week", indexes = {
		@Index(name = "IDX_NEWSLA_WEEK_TIMESTAMP", columnNames = {"timeStamp","APMAC","OWNER"}),
		@Index(name = "IDX_NEWSLA_WEEK_OWNER", columnNames = {"OWNER"})
		})
public class AhNewSLAStatsWeek implements AhNewSLAStatsInterface {
