...
@Entity
@Table(name = "hm_appdata_hour")
@org.hibernate.annotations.Table(appliesTo = "hm_appdata_hour", indexes = {
		@Index(name = "IDX_APPDATAHOUR_TIMESTAMP", columnNames ={"timeStamp","apMac","application"}),
		@Index(name = "IDX_APPDATAHOUR_OWNER", columnNames = {"OWNER"})
	    })

public class AhAppDataHour implements ApReportData {
