...
@Entity
@Table(name = "ah_new_sla_stats_hour")
@org.hibernate.annotations.Table(appliesTo = "ah_new_sla_stats_hour", indexes = {
		@Index(name = "IDX_NEWSLA_HOUR_TIMESTAMP", columnNames = {"timeStamp","APMAC","OWNER"}),
		@Index(name = "IDX_NEWSLA_HOUR_OWNER", columnNames = {"OWNER"})
		})
public class AhNewSLAStatsHour implements AhNewSLAStatsInterface {
