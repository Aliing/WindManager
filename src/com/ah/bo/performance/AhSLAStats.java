...
@Entity
@Table(name = "ah_sla_stats")
@org.hibernate.annotations.Table(appliesTo = "ah_sla_stats", indexes = {
		@Index(name = "IDX_SLA_TIMESTAMP", columnNames = {"timeStamp","OWNER"}),
		@Index(name = "IDX_SLA_OWNER", columnNames = {"OWNER"})
		})
public class AhSLAStats implements HmBo {
