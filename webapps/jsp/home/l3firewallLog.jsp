													...
													<td width="150px" style="padding-left: 5px;">
														<table id="messageSection" border="0" cellspacing="0"
															...
															<tr>
																...
																<td width="30px">
																	<div id="beginDateTimeDiv" disabled="%{!timeRange}"/>
																</td>
																<td>
													...
													<td width="150px" style="padding-left: 5px;">
														<table border="0" cellspacing="0" cellpadding="0">
															<tr>
																...
																<td width="30px">
																	<div id="endDateTimeDiv" disabled="%{!timeRange}"/>
																</td>
																<td>
										...
										<s:iterator value="%{selectedColumns}">
											<s:if test="%{columnId == 1}">
												<th align="left" nowrap>
													<ah:sort name="clientIp" key="admin.l3firewallLog.clientIp" />
												</th>
											</s:if>
											<s:if test="%{columnId == 2}">
												<th align="left" nowrap>
													<ah:sort name="username" key="admin.l3firewallLog.username" />
												</th>
											</s:if>
											<s:if test="%{columnId == 3}">
												<th align="left" nowrap>
													<ah:sort name="device" key="admin.l3firewallLog.device" />
												</th>
											</s:if>
											<s:if test="%{columnId == 4}">
												<th align="left" nowrap>
													<s:text name="admin.l3firewallLog.source" />
												</th>
											</s:if>
											<s:if test="%{columnId == 5}">
												<th align="left" nowrap>
													<s:text name="admin.l3firewallLog.destination" />
												</th>
											</s:if>
											<s:if test="%{columnId == 6}">
												<th align="left" nowrap>
													<ah:sort name="service" key="admin.l3firewallLog.service" />
												</th>
											</s:if>
											<s:if test="%{columnId == 7}">
												<th align="left" nowrap>
													<ah:sort name="action" key="admin.l3firewallLog.action" />
												</th>
											</s:if>
											<s:if test="%{columnId == 8}">
												<th align="left" nowrap>
													<ah:sort name="operationTime" key="admin.l3firewallLog.operationTime" />
												</th>
											</s:if>
