...
#sliderAnchor img{width: 18px;height: 18px; border: 0px;}
#sliderAnchor img.collapsePanel {background: url(<s:url value="/images/slider.gif" includeParams="none"/>) no-repeat 0px 0px;}
#sliderAnchor img.expandPanel {background: url(<s:url value="/images/slider.gif" includeParams="none"/>) no-repeat -18px 0px;}
#sliderAnchor img.collapseMouseOver {background: url(<s:url value="/images/slider.gif" includeParams="none"/>) no-repeat 0px -94px;}
#sliderAnchor img.expandMouseOver {background: url(<s:url value="/images/slider.gif" includeParams="none"/>) no-repeat -18px -94px;}
td.hide{display: none;}

.mainContent {
<s:if test="%{easyMode && exConfigGuideFeature != null}">
background-image: url(images/hm/express/hm-bkg.png);
...
function onLoadEvent() {
	...
	sizeLeftMenu();
	if(location.href.indexOf("dashboard.action") != -1) {
...
function triggerSlider(){
	...
	if(Dom.getStyle(leftMenuBar, "display") != "none"){//collapse
		...
		Dom.removeClass(leftMenuBar, "hide");
		//Dom.setStyle(sliderAnchor, "left", "-20px");
		Dom.setAttribute(child, "title", "Hide left panel");
		Dom.replaceClass(child, "expandMouseOver", "collapsePanel");
		Dom.setStyle(child, "height", "18px");
		Dom.setStyle(Get("bodyTD"), "padding-left", "5px");
		showLeftMenu();
	}
}
...
function overImageStyle() {
	...
	if(Dom.getStyle(leftMenuBar, "display") != "none"){//collapse
		Dom.replaceClass(child, "collapsePanel", "collapseMouseOver");
	}else{
		Dom.replaceClass(child, "expandPanel", "expandMouseOver");
	}
}
...
function outImageStyle() {
	...
	if(Dom.getStyle(leftMenuBar, "display") != "none"){//collapse
		Dom.replaceClass(child, "collapseMouseOver", "collapsePanel");
	}else{
		Dom.replaceClass(child, "expandMouseOver", "expandPanel");
	}
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<div class="mainContent">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td id="leftMenuBar" class="dark" valign="top" >
				...
				<td valign="top" class="client" style="padding: 4px 4px 0px 5px;" width="100%" id="bodyTD">
