...
<div id="content"><s:form action="hiveAp">
  ...
  --%>
					...
					<td><input type="button" name="ignore" value="Remove"
						...
						<s:property value="writeDisabled" />></td>
					<%--
					<td><input type="button" name="ignore" value="Move to..."
					...
					<%--
					<td><input type="button" name="ignore" value="Config"
						class="button" onClick="submitAction('config');"></td>
					--%>
				...
				<tr>
					...
					<s:iterator value="%{selectedColumns}">
						...
						<s:if test="%{columnId == 21}">
							<th><ah:sort name="serialNumber" key="hiveAp.serialNumber" /></th>
						</s:if>
