(function($, _){
	...
	ahDash.prototype.__blankWidgetHeight = 325;
	ahDash.prototype.__chartsCountLimitation = 25;
	...
	ahDash.prototype.__prepareCertainChartConfigs = function(chart, doConfigType) {
		...
		chart.ctlButtons.addCustomAttribute('__TopologySelect', 'configFunc', function(divName){
			...
			if (self.topologyConfigFunc) {
				self.topologyConfigFunc(chartTmp, divName, chartTmp.reportId, chartHelperArgs.oWidgetId, doConfigType);
			}
		});
	...
	ahDash.prototype.__refreshRequestData = function(chart) {
		...
		chart.additionalArgs.add(false, "daType", "report");
