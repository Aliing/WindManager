...
do
    ...
    then
      ...
      #then
      #	/bin/cp -rf ./$file/* $MAP_DOWNLOADS_HOME/$file
      #fi
      ...
      ##if [ ! -d $MAP_HIVEMANAGE_HOME/tomcat/webapps/"$APP_HOME"/res/fingerprints ]
      ##then
      ##	mkdir -p $MAP_HIVEMANAGE_HOME/tomcat/webapps/"$APP_HOME"/res/fingerprints
      ##fi
      ##if [ -d $HM_ROOT/res/fingerprints ]
      ##then
      ##	/bin/cp -rf $HM_ROOT/res/fingerprints/* $MAP_HIVEMANAGE_HOME/tomcat/webapps/"$APP_HOME"/res/fingerprints
      ##fi
