...
$UPDATE_HOME/HiveManager/script/shell/setDBinfo2web.sh localhost 5432 hm $db_user $db_passwd  $HM_ROOT/WEB-INF/classes/hibernate.cfg.xml  $HM_ROOT/WEB-INF/classes/resources/hmConfig.properties
